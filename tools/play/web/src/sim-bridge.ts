// Browser-side bridge to the sim module — copied from
// tools/designer/web/src/sim-bridge.ts. Fetches /api/cards (served by
// the designer server on port 7321) and constructs a typed
// ContentBundle. When the match server lands this is what'll be
// replaced with snapshot-pinned content from the server.
